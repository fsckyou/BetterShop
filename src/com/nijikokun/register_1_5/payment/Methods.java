...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new com.nijikokun.register_1_5.payment.methods.iCo6());
        addMethod("iConomy", new com.nijikokun.register_1_5.payment.methods.iCo5());
        addMethod("iConomy", new com.nijikokun.register_1_5.payment.methods.iCo4());
        addMethod("BOSEconomy", new com.nijikokun.register_1_5.payment.methods.BOSE6());
        addMethod("BOSEconomy", new com.nijikokun.register_1_5.payment.methods.BOSE7());
        addMethod("Essentials", new com.nijikokun.register_1_5.payment.methods.EE17());
        addMethod("Currency", new com.nijikokun.register_1_5.payment.methods.MCUR());
        addMethod("3co", new com.nijikokun.register_1_5.payment.methods.ECO3());
     ...
     * method initialized in register_1_5.
     *
