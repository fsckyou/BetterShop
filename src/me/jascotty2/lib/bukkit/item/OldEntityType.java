/*
 * copy of EntityType.java, as of compile time
...
public enum OldEntityType {
    ...
    private static final Map<String, OldEntityType> NAME_MAP = new HashMap<String, OldEntityType>();
    private static final Map<Short, OldEntityType> ID_MAP = new HashMap<Short, OldEntityType>();
    ...
    public static OldEntityType fromName(String name) {
        if (name == null) {
            return null;
        }
    ...
    public static OldEntityType fromId(int id) {
    ...
    /**
     * Some entities cannot be spawned using {@link World#spawnCreature(Location, OldEntityType)}
